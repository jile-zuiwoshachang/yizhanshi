...
import com.yizhanshi.system.domain.SysConfig;
import com.yizhanshi.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    {
        Collection<String> keys = redisService.keys(CacheConstants.system_config_KEY + "*");
