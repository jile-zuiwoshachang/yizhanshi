...
public class SysMenuController extends BaseController
{
    ...
    @GetMapping("/list")
    public AjaxResult list(SysResource menu)
    {
        Long userId = SecurityUtils.getUserId();
        List<SysResource> menus = menuService.selectMenuList(menu, userId);
    ...
    public AjaxResult treeselect(SysResource menu)
    {
        Long userId = SecurityUtils.getUserId();
        List<SysResource> menus = menuService.selectMenuList(menu, userId);
    ...
    {
        Long userId = SecurityUtils.getUserId();
        List<SysResource> menus = menuService.selectMenuList(userId);
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody SysResource menu)
    {
    ...
    @PutMapping
    public AjaxResult edit(@Validated @RequestBody SysResource menu)
    {
        if (!menuService.checkMenuNameUnique(menu))
        {
    ...
    {
        Long userId = SecurityUtils.getUserId();
        List<SysResource> menus = menuService.selectMenuTreeByUserId(userId);
